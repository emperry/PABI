...
C_SRCS += \
../EthLib/loopback/loopback.c 

C_DEPS += \
./EthLib/loopback/loopback.d 

OBJS += \
./EthLib/loopback/loopback.o 


# Each subdirectory must supply rules for building sources it contributes
EthLib/loopback/%.o EthLib/loopback/%.su: ../EthLib/loopback/%.c EthLib/loopback/subdir.mk
...
clean: clean-EthLib-2f-loopback

clean-EthLib-2f-loopback:
	-$(RM) ./EthLib/loopback/loopback.d ./EthLib/loopback/loopback.o ./EthLib/loopback/loopback.su

.PHONY: clean-EthLib-2f-loopback
